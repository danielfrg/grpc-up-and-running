...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CombinedShipment {
    #[prost(string, tag = "1")]
    pub id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub status: ::prost::alloc::string::String,
    #[prost(message, repeated, tag = "3")]
    pub orders_list: ::prost::alloc::vec::Vec<Order>,
}
...
pub mod order_management_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn update_orders(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::Order>,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/ecommerce.OrderManagement/updateOrders");
            self.inner
        ...
        pub async fn process_orders(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = ::prost::alloc::string::String>,
        ) -> Result<tonic::Response<tonic::codec::Streaming<super::CombinedShipment>>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/ecommerce.OrderManagement/processOrders");
            self.inner
